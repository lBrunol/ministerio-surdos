<?php
    function ebenezer_get_the_archive_title() {
        if ( is_category() ) {            
        ...
        return apply_filters( 'ebenezer_get_the_archive_title', $title );
    }

    function ebenezer_get_the_archive_description() {
        $description = isset( get_queried_object() -> description ) ? get_queried_object() -> description : false;
    
        return apply_filters( 'ebenezer_get_the_archive_description', $description );
    }
    ...
    */
    ...
    function ebenezer_get_the_post_tags() {
    ...
    */
    function ebenezer_get_post_type_data( $post_id = 0 ) {
        if ( $post_id ) {
    ...
    */
     ...
     */
    function ebenezer_crop_text( $str, $maxLength = 100) {
